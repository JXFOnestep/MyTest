...
public class Commons {
    ...
    public static Map<String, String> social() {
        ...
        map.put("csdn", WebConstant.initConfig.get(prefix + "csdn"));
        map.put("jianshu", WebConstant.initConfig.get(prefix + "jianshu"));
        map.put("resume", WebConstant.initConfig.get(prefix + "resume"));
